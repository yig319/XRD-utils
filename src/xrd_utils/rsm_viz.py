...
class RSMPlotter:
    def __init__(self, plot_params:dict | None = None):
        """
        Initializes an instance of the RSMPlotter class with optional plotting parameters.

        Parameters:
            plot_params (dict, optional): A dictionary containing parameters for customizing the plot.
                If not provided, default parameters will be used. The dictionary can include keys such as:
                - 'reciprocal_space': (bool) Whether to plot in reciprocal space. Default is True.
                - 'title': (str) Title of the plot. Default is None.
                - 'figsize': (tuple) Size of the figure. Default is None.
                - 'cmap': (Colormap) Colormap to use for the plot. Default is plt.cm.viridis.
                - 'title_fontsize': (int) Font size for the title. Default is 12.
                - 'label_fontsize': (int) Font size for the axis labels. Default is 10.
                - 'tick_fontsize': (int) Font size for the tick labels. Default is 8.
                - 'log_scale': (bool) Whether to use logarithmic scale for intensity. Default is True.
                - 'cbar_value_format': (str) Format for colorbar values. Default is 'actual'.
                - 'cbar_levels': (int) Number of levels in the colorbar. Default is 20.
                - 'cbar_ticks': (int) Number of ticks on the colorbar. Default is 10.
                - 'cbar_size': (int) Size of the colorbar. Default is 8.
                - 'cbar_fraction': (float) Fraction of the colorbar size relative to the plot. Default is 0.05.
                - 'cbar_pad': (float) Padding between the plot and the colorbar. Default is 0.02.
                - 'show_xaxis': (str) Determines which x-axis to show ('first', 'last', or 'both'). Default is 'last'.
                - 'show_yaxis': (str) Determines which y-axis to show ('first', 'last', or 'both'). Default is 'first'.
                - 'vmin': (int) Minimum intensity value for the plot. Default is 3.
                - 'vmax': (int) Maximum intensity value for the plot. Default is 1000.
                - 'custom_bg_color': (str) Custom background color for the plot. Default is None.
